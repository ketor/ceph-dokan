...
/*
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
This file is very different from include/cephfs/libcephfs.h and is only use for ceph-dokan
Don't replace this file with the origin.
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
*/
...
void ceph_printf_stdout(const char* strlog);
