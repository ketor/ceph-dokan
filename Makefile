...
test-cephfs.exe:test_cephfs.o $(PATHBIN)/libcephfs.dll
	$(CPP) $(CFLAGS) $(CLIBS) -o $@ $^ -lws2_32 -lpthread
	@echo "**************************************************************"
	@echo "MAKE "$@" FINISH"
	@echo "**************************************************************"
